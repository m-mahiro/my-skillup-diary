...
[Apache](./02-Apache.md)|Webサーバ
[MySQL](./03-MySQL.md)|データベースの一つ。表形式でデータを管理する。
[PHP](./04-PHP.md)|動的なWebサイトを作成するためのプログラミング言語

これらはWebアプリ開発の4種のの神器である。
習得することでWebアプリケーションを開発できるようになる。
